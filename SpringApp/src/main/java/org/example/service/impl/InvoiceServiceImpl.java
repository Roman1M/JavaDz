...
public class InvoiceServiceImpl implements IInvoiceService {
    ...
    // Specify which StorageService implementation to use
    @Autowired
    @Qualifier("storageServiceImpl")  // Use "fileSystemStorageService" if you want to use that one
    ...
    public Invoice saveInvoice(InvoiceCreateDTO dto) {
        try {
            ...
            // Save the file using the specified storage service
