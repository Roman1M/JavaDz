...
public class ProductSeeder implements CommandLineRunner {
    ...
    public ProductSeeder(@Qualifier("storageServiceImpl") StorageService storageService, CategoryRepository categoryRepository) {
    ...
    public void run(String... args) throws IOException {
        if (categoryRepository.count() == 0) {
            int categoryCount = 3; //кількість категорій
